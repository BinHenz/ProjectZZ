...
void UZZBaseAttributeSet::SetupRelatedAttributes()
{
...
void UZZBaseAttributeSet::UpdateMaxTagOnReplicated(const FGameplayAttribute& Attribute)
{
...
void UZZBaseAttributeSet::PreAttributeBaseChange(const FGameplayAttribute& Attribute, float& NewValue) const
{
	Super::PreAttributeBaseChange(Attribute, NewValue);
	ClampAttribute(Attribute, NewValue);
}

void UZZBaseAttributeSet::PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue)
{
	Super::PreAttributeChange(Attribute, NewValue);
	ClampAttribute(Attribute, NewValue);
}

void UZZBaseAttributeSet::PostAttributeChange(const FGameplayAttribute& Attribute, float OldValue, float NewValue)
{
...
void UZZBaseAttributeSet::ClampAttribute(const FGameplayAttribute& Attribute, float& NewValue) const
{
...
void UZZBaseAttributeSet::UpdateMaxTag(const FGameplayTag& Tag, const float& Base, const float& Max,
