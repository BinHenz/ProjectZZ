...
#include "Ability/ZZInputID.h"
#include "Engine/DataAsset.h"
#include "ZZAbilityInputSet.generated.h"
...
struct FZZAbilityInputInfo : public FZZInputID
{
	GENERATED_BODY()
	 ...
	 */
	template <typename T>
	FZZInputHandle BindAction(UEnhancedInputComponent* InputComponent, T* Object,
 ...
 */
UCLASS()
class PROJECTZZ_API UZZAbilityInputSet : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	void BindActions(UEnhancedInputComponent* InputComponent, T* Object, TInputActionCallback<T> InputHandler,
					 FZZInputHandleContainer& HandleContainer) const
	{
...
private:
	...
	UPROPERTY(EditAnywhere)
	TArray<FZZAbilityInputInfo> AbilityInputBindings;
};
